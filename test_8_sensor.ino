...
void gerakroda2() {
  ...
  digitalWrite(in2, LOW);   // Motor A maju
  digitalWrite(in3, HIGH);  // Motor B maju
  digitalWrite(in4, LOW);   // Motor B maju
...
void stop() {
  digitalWrite(in1, HIGH);  // Motor A berhenti
  digitalWrite(in2, LOW);   // Motor A berhenti
  digitalWrite(in3, HIGH);  // Motor B berhenti
...
void loop() {
  ...
  delay(200);  // Delay 500 ms sebelum loop berikutnya
}
